# Generated by Django 5.2.5 on 2025-09-21 14:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_trainer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='trainees', to=settings.AUTH_USER_MODEL)),
                ('helpers', models.ManyToManyField(blank=True, related_name='main_trainer', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='measurements/')),
